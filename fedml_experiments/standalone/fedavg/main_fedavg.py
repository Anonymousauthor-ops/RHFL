...
from fedml_api.model.cv.cnn import CNN_DropOut, CNN_DropOut1
from fedml_api.data_preprocessing.FederatedEMNIST.data_loader import load_partition_data_federated_emnist
from fedml_api.model.nlp.rnn import RNN_OriginalFedAvg, RNN_OriginalFedAvg1, RNN_StackOverFlow

from fedml_api.data_preprocessing.MNIST.data_loader import load_partition_data_mnist_new, load_partition_data_cifar10, load_partition_data_mnist   # 调用
from fedml_api.data_preprocessing.fashionmnist.data_loader import load_partition_data_fashionmnist_new
from fedml_api.model.linear.lr import LogisticRegression
from fedml_api.model.cv.resnet_gn import resnet18, resnet18mnist

from fedml_api.standalone.fedavg.fedavg_api import FedAvgAPI
from fedml_api.standalone.fedavg.my_model_trainer_classification import MyModelTrainer as MyModelTrainerCLS
from fedml_api.standalone.fedavg.my_model_trainer_nwp import MyModelTrainer1 as MyModelTrainerNWP
from fedml_api.standalone.fedavg.my_model_trainer_tag_prediction import MyModelTrainer2 as MyModelTrainerTAG
...
def add_args(parser):
    ...
    parser.add_argument('--ci', type=int, default=0,
                        help='CI')
    parser.add_argument('--budget', type=dict, default={'cnn_0':500,'cnn_1': 500,'cnn_2': 500},
                        help='budget')
    parser.add_argument('--task_array', type=list, default=['cnn', 'rnn', 'resnet20','resnet18_gn1'],
                        help='task_array')

    parser.add_argument('--k', type=int, default=3,
                        help='model_sum')
    parser.add_argument('--task_name', type=str, default='cnn',
    # parser.add_argument('--task_name', type=str, default='resnet20',
                        help='task_name')
    parser.add_argument('--malicious_m', type=int, default=60,
                        help='malicious_m')
    parser.add_argument('--method_name', type=str, default='JSHFL',  # defenses
                        help='method_name')
    parser.add_argument('--attack_type', type=str, default='label',  # attacks
                        help='attack_type')
...
def load_data(args, dataset_name):
    ...
    if dataset_name == "mnist":
        ...
        class_num, data_size_bid, num_sample_data = load_partition_data_mnist_new(args)
        """
        ...
        client_num, train_data_num, test_data_num, train_data_global, test_data_global, \
        train_data_local_num_dict, train_data_local_dict, test_data_local_dict, \
        class_num, data_size_bid, num_sample_data = load_partition_data_cifar10(args)
        """
        For shallow NN or linear models, 
        we uniformly sample a fraction of clients each round (as the original FedAvg paper)
        """
        ...
        client_num, train_data_num, test_data_num, train_data_global, test_data_global, \
        train_data_local_num_dict, train_data_local_dict, test_data_local_dict, \
        class_num, data_size_bid, num_sample_data = load_partition_data_fashionmnist_new(args)
        """
        For shallow NN or linear models, 
        we uniformly sample a fraction of clients each round (as the original FedAvg paper)
        """
...
def create_model(args, model_name, output_dim):
    ...
    elif model_name == "resnet18_gn1" and args.dataset == "mnist":
    ...
    elif model_name == "rnn" and args.dataset == "mnist":
...
if __name__ == "__main__":
    ...
    print("total_time：", round(end-start)/60, 'minutes')
